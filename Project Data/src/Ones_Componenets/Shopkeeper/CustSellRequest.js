...
fetch("http://localhost:8080/updateStatusrequest",reqData)
.then(resp=>resp.json())
...
alert("updated Successfully");
   ...
   const setter=(e)=>{
    ...
    return(
       ...
       <div style={{borderStyle:"solid", backgroundColor:"lightcyan", borderWidth:"2px", zIndex:"3", position:"absolute",left:"0px", width:"1125px", top:"750px"}} hidden={hideF} >
						  <table border={"1"} className="table" style={{borderCollapse:"collapse"}} cellPadding={"5"} >
					    <tr>
                          <th>Select</th>    
                        <th>Book Name</th>
